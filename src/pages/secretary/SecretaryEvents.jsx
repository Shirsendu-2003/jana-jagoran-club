...
export default function SecretaryEvents() {
  ...
  const onSubmit = async (data) => {
    await secretaryApi.createEvent(data);
  ...
  const onDelete = async (id) => {
    ...
    await secretaryApi.deleteEvent(id);
    load();
  };
  ...
  return (
    <DashboardLayout>
      ...
      <p className="text-gray-500 mb-6">Plan and manage club events.</p>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="card lg:col-span-1">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
            ...
            <input className="input-field" placeholder="Image URL (optional)" {...register('imageUrl')} />
